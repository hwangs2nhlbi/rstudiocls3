...
trait.results <-paste("/restricted/projectnb/cvdmrx/cacscnt2/gen3/rst")
# setwd("/restrcited/projectnb/cvdmrx/cacscnt2/gen3/rst")
## go to each rst directory cat *csv> "traitmodel"rst.csv ##
load("/restricted/projectnb/cvdmrx/cacscnt2/gen3/rst/g3ascac2.RData")
 colnames(g3ascac2) <- c("IlmnID","beta","se","p","totaln")

## load annotation data
load("/restricted/projectnb/fhs-methylation/cleaned/scripts/shuo/HumanMethylation450_15017482_simple.Rdata")
post.dir <- "/restricted/projectnb/cvdmrx/cacscnt2/gen3/rst/" 
png_file_name <- "g3ascac2"
## merge results with annotation data
dd2   <- merge(g3ascac2,annotM,by="IlmnID")
...
write.table(dd2, file=paste(post.dir,"g3ascac2705.csv"),sep=",",row.names=F,quote=F)
b    <- dd2[order(dd2$p),]
...
QQplot_png(g3ascac2$p, paste(post.dir,"/QQ_plot_","gen3ascac2",".png",sep=""))
...
write.table(b2, file =paste(post.dir,"/","g3ascac2","_top_cpgs.csv", sep=""),sep=",",row.names=F,quote=F)
...
MH_plot_PNG(out4, paste(post.dir,"/MH_plot_","g3ascac2",".png", sep=""), mytitle="g3ascac2")
